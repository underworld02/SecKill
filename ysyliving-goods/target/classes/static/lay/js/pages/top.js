const lyTop = {
                    ...
                    <div class='yui3-u Right shopArea'> \
                        <div class='fr shopcar'> \
                            <div class='show-shopcar' id='shopcar'> \
                                <span class='car'></span> \
                                <a class='sui-btn btn-default btn-xlarge' href='#' target='_blank'> \
                                    <span>我的购物车</span> \
                                    <i class='shopnum'>0</i> \
                                </a> \
        ...
        search() {
            ...
            fetch(url, {
                ...
                .then(resp => {
                    ...
                    this.$emit('search-results', resp.data.items);
                    // this.$eventBus.$emit('search-results', data.items);
                    //    获取过滤结果，形成过滤项
                }).catch(Error => {
                console.error("Failed to load data:0");
            });
            // const url = '/api/goods/goods/search/page';
            // const data = { key: this.key };
            // fetch(url, {
    ...
    components: {
        shortcut:() => import('/static/lay/js/pages/shortcut.js')
    }
}
