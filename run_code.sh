CUDA_VISIBLE_DEVICES=0,1,2,3 python examples/cluster_contrast_train_usl.py -b 64 -a resnet50 -d market1501 --iters 50 --momentum 0.1 --eps 0.6 --num-instances 16
